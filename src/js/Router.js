...
/**
 * A collection of Laraigniter routes. This class constitutes RouteJS's main API.
 */
export default class Router extends String {
     ...
     * @param {Object} [config] - RouteJS configuration.
     */
     ...
     * (new Router('posts.show', 1)).toString(); // 'https://example.dev/posts/1'
     *
     * @return {String}
     */
    toString() {
     ...
     *
     * @example
     * // at URL https://example.dev/posts/4 with 'posts.show' route 'posts/{post}'
     ...
     *
     * @example
     * // at URL https://example.dev/posts/4?lang=en with 'posts.show' route 'posts/{post}' and domain '{team}.example.dev'
     * route().params; // { team: 'test', post: 4, lang: 'en' }
     *
     * @return {Object}
     */
    get params() {
    ...
    /**
     * Parse Laraigniter-style route parameters of any type into a normalized object.
     *
     * @example
    ...
    /**
     * Substitute Laraigniter route model bindings in the given parameters.
     *
     * @example
        ...
        return Object.entries(params).reduce((result, [key, value]) => {
            ...
            if (!value.hasOwnProperty(bindings[key])) {
                if (value.hasOwnProperty('id')) {
                    ...
                    throw new Error(`RouteJS error: object passed as '${key}' parameter is missing route model binding key '${bindings[key]}'.`)
                }
            }
