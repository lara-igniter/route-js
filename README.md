# route-js – Use your Laraigniter routes in JavaScript

route-js provides a JavaScript `route()` helper function that works like Laraigniter's, making it easy to use your Laraigniter named routes in JavaScript.

route-js supports all versions of Laraigniter from `1.x` onward, and all modern browsers.
